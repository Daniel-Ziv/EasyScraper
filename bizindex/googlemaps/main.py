...
with open('categories', 'r', encoding='utf-8') as category_file:
...
for category in categories:
    for city in cities:
        ...
        perentofli = driver.find_element(By.XPATH, "//*[@id='listContent']/div/div/ul")  # Modify the XPath as needed
...
data_df.to_csv('search_results.csv', index=False, encoding='utf-8')
