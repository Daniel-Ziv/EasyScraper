...
for category in categories:
    for city in cities:
        ...
        search_input = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.ID, "SearchInputBiz")))
        ...
        print(current_url)
        try :
            perentofli = WebDriverWait(driver, 15).until(EC.presence_of_element_located((By.ID, "listContent")))  # Modify the XPath as needed
        except Exception:
            continue
